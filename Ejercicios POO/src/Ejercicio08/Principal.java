...
public class Principal {
	public static void main(String[] args) {
		...
		Punto coordenada10 = new Punto();
		Punto coordenada11 = new Punto();
		Punto coordenada12 = new Punto();
		Punto coordenada13 = new Punto();
		...
		System.out.print("X = " + coordenada10.x + " , " + " Y = " + coordenada10.y + " " + cuadrante1.cuadrante(coordenada10.x, coordenada10.y));
		distancia1.distancia(coordenada10.x, coordenada10.y);
		System.out.println();
		
		coordenada10.moverA1(coordenada10.x, coordenada10.y);
		System.out.print("X = " + coordenada10.x + " , " + " Y = " + coordenada10.y + " " + cuadrante1.cuadrante(coordenada10.x, coordenada10.y));
		distancia1.distancia(coordenada10.x, coordenada10.y);
		System.out.println();
		
		System.out.print("X = " + coordenada11.x + " , " + " Y = " + coordenada11.y + " " + cuadrante1.cuadrante(coordenada11.x, coordenada11.y));
		distancia1.distancia(coordenada11.x, coordenada11.y);
		System.out.println();
		
		coordenada11.moverA1(coordenada11.x, coordenada11.y);
		System.out.print("X = " + coordenada11.x + " , " + " Y = " + coordenada11.y + " " + cuadrante1.cuadrante(coordenada11.x, coordenada11.y));
		distancia1.distancia(coordenada11.x, coordenada11.y);
		System.out.println();
		
		System.out.print("X = " + coordenada12.x + " , " + " Y = " + coordenada12.y + " " + cuadrante1.cuadrante(coordenada12.x, coordenada12.y));
		distancia1.distancia(coordenada12.x, coordenada12.y);
		System.out.println();
		
		coordenada12.moverA1(coordenada12.x, coordenada12.y);
		System.out.print("X = " + coordenada12.x + " , " + " Y = " + coordenada12.y + " " + cuadrante1.cuadrante(coordenada12.x, coordenada12.y));
		distancia1.distancia(coordenada12.x, coordenada12.y);
		System.out.println();
		
		System.out.print("X = " + coordenada13.x + " , " + " Y = " + coordenada13.y + " " + cuadrante1.cuadrante(coordenada13.x, coordenada13.y));
		distancia1.distancia(coordenada13.x, coordenada13.y);
		System.out.println();
		
		coordenada13.moverA1(coordenada13.x, coordenada13.y);
		System.out.print("X = " + coordenada13.x + " , " + " Y = " + coordenada13.y + " " + cuadrante1.cuadrante(coordenada13.x, coordenada13.y));
		distancia1.distancia(coordenada13.x, coordenada13.y);
		System.out.println();
		System.out.println();
